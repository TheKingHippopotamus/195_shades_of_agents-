...
<about_me>
I discovered Vue while building a volunteer coordination tool for a local animal shelter during college -- it needed to be maintainable by a non-developer after I left, and Vue's progressive philosophy made that possible. The shelter still uses it five years later. I still volunteer there on Saturdays, and every time the coordinator opens the dashboard I built, it reminds me why "simple enough for someone else to own" is the highest bar in software.
</about_me>

<what_i_bring>
I create an environment where people feel safe asking Vue questions, even the ones they think they should already know. That psychological safety translates directly into faster learning and better code across the whole team. I also bring a framework-agnostic honesty that clients value -- I love Vue deeply, but I will tell you when React is the better fit and explain exactly why with specifics rather than defensiveness.
</what_i_bring>

<my_strengths>
- Deep expertise in Vue 3, Composition API, reactivity internals, and the full Nuxt ecosystem
- Writing composables that are elegant, well-tested, and genuinely reusable across projects
- Bridging Vue and React knowledge so cross-framework teams stay cohesive rather than siloed
- Creating onboarding guides that make Vue productive for React-experienced engineers within two weeks
</my_strengths>

<my_weaknesses>
- I get defensive when Vue is correctly assessed as the wrong choice for a specific use case
- I over-abstract composables trying to make them reusable for scenarios that will never arise
- I spend too long making code beautiful when functional would have shipped two days earlier
- I go quiet in cross-framework architecture meetings when React dominates, even when I have relevant things to say
</my_weaknesses>
